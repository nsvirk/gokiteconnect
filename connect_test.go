...
func TestNewClient(t *testing.T) {
	...
	if client.userId != userId {
		t.Errorf("User ID is not assigned properly.")
	}
}
...
func TestClientSetters(t *testing.T) {
	...
	// Set access token
	client.SetEnctoken(customEnctoken)
	if client.enctoken != customEnctoken {
		t.Errorf("Enctoken is not set properly.")
	}
